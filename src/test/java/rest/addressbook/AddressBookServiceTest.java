...
public class AddressBookServiceTest {
	...
	public void serviceIsAlive() throws IOException {
		...
		/*
		 * Requests once again the address books and checks if the 
		 * response is either equal or not to the first request, i.e
		 * the status is the same and the list size is 0.
		 */ 
	...
	public void createUser() throws IOException {
		...
		//////////////////////////////////////////////////////////////////////
		//Adds once again the same person to the address book.
		Response response2 = client.target("http://localhost:8282/contacts")
				.request(MediaType.APPLICATION_JSON)
				.post(Entity.entity(juan, MediaType.APPLICATION_JSON));
		/*
		 * Checks that the POST method is not idempotent comparing the ID 
		 * and the URI of the first and the second person, that should
		 * be different.
		 */
		 assertEquals(201, response2.getStatus());
		 Person juan2 =  response2.readEntity(Person.class);
		 assertNotEquals(juanUpdated.getId(), juan2.getId());
		 assertNotEquals(juanUpdated.getHref(), juan2.getHref());
		 /*
		  * Checks that the POST method is not safe comparing the size
		  * of the list is two and not one (proving that the post have
		  * modified the address book).
		  */
		  Response getResponse = client.target("http://localhost:8282/contacts")
				.request(MediaType.APPLICATION_JSON).get();
		  assertEquals(200, getResponse.getStatus());
		  assertEquals(2, getResponse.readEntity(AddressBook.class).getPersonList()
				.size()); 		
	}
	...
	public void listUsers() throws IOException {
		...
		Response response2 = client.target("http://localhost:8282/contacts")
				.request(MediaType.APPLICATION_JSON)
				.post(Entity.entity(thor, MediaType.APPLICATION_JSON));
		assertEquals(201, response2.getStatus());
		/*
		 * Checks that the POST method is not idempotent, i.e it has modified
		 * the address book.
		 */ 
		Response getResponse = client.target("http://localhost:8282/contacts")
				.request(MediaType.APPLICATION_JSON).get();
		assertEquals(200, getResponse.getStatus());
		assertEquals(3, getResponse.readEntity(AddressBook.class).getPersonList()
				.size()); 
		/*
		 * Adds a new person in order to check that it will introduce a new person,
		 * i.e is not a safe method.
		 */ 
		 Response response3 = client.target("http://localhost:8282/contacts")
				.request(MediaType.APPLICATION_JSON)
				.post(Entity.entity(thor, MediaType.APPLICATION_JSON));
		 assertEquals(201, response3.getStatus());
		 Person thor1 = response2.readEntity(Person.class);
		 Person thor2 = response3.readEntity(Person.class);
		 assertNotEquals(thor1.getId(), thor2.getId());
		 assertNotEquals(thor1.getHref(), thor2.getHref());		
	}
	...
	public void updateUsers() throws IOException {
		...
		//////////////////////////////////////////////////////////////////////
		//Introduce the same update for the given URI.
		...
		//Checks that the update returns just the same as the first time.
		...
		/*
		 * Cheks that the PUT method is not safe comparing the original
		 * name of the person with the juanURI with the name after being updated.
		 */ 			
	...
	public void deleteUsers() throws IOException {
		...
		/*
		 * Tries to delete once again the same user and checks that the answer is the
		 * same as the last time. This proves the DELETE method is both idempotent,
		 * cause the answer is the same, and not safe, cause it has delete something
		 * from the server.
		 */ 	
